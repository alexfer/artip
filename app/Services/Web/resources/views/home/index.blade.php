...
<div class="row mb-2">
    ...
    <div class="col-md-6">
        <div class="card flex-md-row mb-4 box-shadow h-md-250">
            ...
            <img class="card-img-right flex-auto d-none d-md-block img-responsive" alt="Thumbnail [200x250]" style="width: 200px; height: 245px;" src="{{ asset('storage/media/picture-2.jpg') }}" data-holder-rendered="true">
        </div>
    </div>
</div>
@endsection
