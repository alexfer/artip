    ...
    <div class="col-md-6">
        <div class="card flex-md-row mb-4 box-shadow h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
                <strong class="d-inline-block mb-2 text-primary">{{ $item->display_name }}</strong>
                <h3 class="mb-0">
            ...
            <div class="card-img-right flex-auto d-none d-md-block img-responsive" style="width: 200px; height: 248px;background: url({{ asset(\Storage::disk('media')->url(sprintf("240-thumb-%s", $item->path))) }})"></div>
        </div>
    </div>
    @endforeach
</div>
